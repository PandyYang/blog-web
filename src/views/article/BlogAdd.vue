      ...
      <el-dialog :visible.sync="addOrEdit" width="40%" top="10vh">
        ...
        <el-form label-width="80px" size="medium" :model="article">
          ...
          <el-form-item label="上传封面">
            ...
            >
              <i class="el-icon-upload" v-if="article.picture == ''" />
              <div class="el-upload__text" v-if="article.picture == ''">
                将文件拖到此处，或<em>点击上传</em>
              </div>
              <img v-else :src="article.picture" width="360px" height="180px" />
            </el-upload>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    uploadCover(response) {
      this.article.picture = response.data.url;
    }
  }
};
</script>
